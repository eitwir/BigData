...
def argpars():
    ...
    parser.add_argument('--N', type=int, help='the number of movies you want to select', default='10')
...
if __name__ == "__main__":
    ...
    print_result(connection, r'D:\DE\Homework\HW_3_SQL_python\files\sql\GET_RESULT.sql', args)
